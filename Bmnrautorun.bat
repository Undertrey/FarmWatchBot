...
SET commandserver1=%minerpath% -uri ethash://0x4a98909270621531dda26de63679c1c6fdcf32ea.%ver%@eu1.ethermine.org:4444 -logfile miner.log -max-temperature 80
SET commandserver2=%minerpath% -uri ethash://0x4a98909270621531dda26de63679c1c6fdcf32ea.%ver%@eu1.ethermine.org:4444 -logfile miner.log -max-temperature 80
SET commandserver3=%minerpath% -uri ethash://0x4a98909270621531dda26de63679c1c6fdcf32ea.%ver%@eu1.ethermine.org:4444 -logfile miner.log -max-temperature 80
SET commandserver4=%minerpath% -uri ethash://0x4a98909270621531dda26de63679c1c6fdcf32ea.%ver%@eu1.ethermine.org:4444 -logfile miner.log -max-temperature 80
...
IF %queue% EQU 0 >> %bat% ECHO %minerpath% -uri ethash://0x4a98909270621531dda26de63679c1c6fdcf32ea.%ver%@eu1.ethermine.org:4444 -logfile miner.log -max-temperature 80
>> %bat% ECHO EXIT
timeout.exe /T 3 /nobreak >NUL
START "%bat%" "%bat%" && (
