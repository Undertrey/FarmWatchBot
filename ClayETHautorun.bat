...
timeout.exe /T 5 /nobreak >NUL
FOR /F "tokens=3,6,9,12,15,18,21,24,27,30,33,36,39,42,45 delims=.,Mh/s " %%a IN ('findstr.exe /R /C:".*GPU.* .* Mh/s.*" %log% ^| findstr.exe /V /R /I /C:".*DevFee.*" /C:".*DCR.*" /C:".*SC.*" /C:".*LBC.*" /C:".*PASC.*"') DO (
