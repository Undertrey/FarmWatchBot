...
SET Server1BatCommand=%MinerProcess% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.fr184 -epsw x -allpools 1 -tstop 80 -logfile miner.log
SET Server2BatCommand=%MinerProcess% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.fr184 -epsw x -allpools 1 -tstop 80 -logfile miner.log
SET Server3BatCommand=%MinerProcess% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.fr184 -epsw x -allpools 1 -tstop 80 -logfile miner.log
SET Server4BatCommand=%MinerProcess% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.fr184 -epsw x -allpools 1 -tstop 80 -logfile miner.log
SET Server5BatCommand=%MinerProcess% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.fr184 -epsw x -allpools 1 -tstop 80 -logfile miner.log
				...
				ECHO !LastInternetError!| findstr.exe /I /R %InternetErrorsList% >NUL && (
					...
					ping.exe google.com| find.exe /I "TTL=" >NUL && (
						...
						IF !ServerQueue! EQU 5 (
							...
							>> %MinerBat% ECHO %MinerProcess% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.fr184 -epsw x -allpools 1 -tstop 80 -logfile miner.log
						)
						>> %MinerBat% ECHO EXIT
						SET /A ServerQueue+=1
