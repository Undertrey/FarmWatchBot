...
SET Server1BatCommand=%MinerProcess% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.fr185 -epsw x -allpools 1 -tstop 80 -logfile %Logfile%
SET Server2BatCommand=%MinerProcess% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.fr185 -epsw x -allpools 1 -tstop 80 -logfile %Logfile%
SET Server3BatCommand=%MinerProcess% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.fr185 -epsw x -allpools 1 -tstop 80 -logfile %Logfile%
SET Server4BatCommand=%MinerProcess% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.fr185 -epsw x -allpools 1 -tstop 80 -logfile %Logfile%
SET Server5BatCommand=%MinerProcess% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.fr185 -epsw x -allpools 1 -tstop 80 -logfile %Logfile%
...
timeout.exe /T 5 /nobreak >NUL
FOR /F "delims=" %%N IN ('findstr.exe /I /R %CriticalErrorsList% %MinerErrorsList% %MinerWarningsList% %InternetErrorsList% %Logfile% ^| findstr.exe /V /R /C:".*DevFee.*" /C:".*DCR.*" /C:".*SC.*" /C:".*LBC.*" /C:".*PASC.*"') DO SET LastError=%%N
IF !LastError! NEQ 0 (
				...
				ECHO !LastInternetError!| findstr.exe /I /R %InternetErrorsList% >NUL && (
					...
					ping.exe google.com| find.exe /I "TTL=" >NUL && (
						...
						IF !ServerQueue! EQU 5 (
							...
							>> %MinerBat% ECHO %MinerProcess% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.fr185 -epsw x -allpools 1 -tstop 80 -logfile %Logfile%
						)
						>> %MinerBat% ECHO EXIT
						SET /A ServerQueue+=1
...
timeout.exe /T 5 /nobreak >NUL
FOR /F "tokens=5 delims=. " %%A IN ('findstr.exe /R /C:".*- Total Speed: .* Mh/s.*" %Logfile% ^| findstr.exe /V /R /C:".*DevFee.*" /C:".*DCR.*" /C:".*SC.*" /C:".*LBC.*" /C:".*PASC.*"') DO (
	SET LastHashrate=%%A
...
timeout.exe /T 5 /nobreak >NUL
	FOR /F "tokens=3,6,9,12,15,18,21,24,27,30,33,36,39,42,45 delims=.,Mh/s " %%a IN ('findstr.exe /R /C:".*GPU.* .* Mh/s.*" %Logfile% ^| findstr.exe /V /R /C:".*DevFee.*" /C:".*DCR.*" /C:".*SC.*" /C:".*LBC.*" /C:".*PASC.*"') DO (
