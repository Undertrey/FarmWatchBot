...
SET commandserver1=%minerpath% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.%ver% -epsw x -allpools 1 -tstop 80 -logfile miner.log -wd 0 -mode 1 -platform 2
SET commandserver2=%minerpath% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.%ver% -epsw x -allpools 1 -tstop 80 -logfile miner.log -wd 0 -mode 1 -platform 2
SET commandserver3=%minerpath% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.%ver% -epsw x -allpools 1 -tstop 80 -logfile miner.log -wd 0 -mode 1 -platform 2
SET commandserver4=%minerpath% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.%ver% -epsw x -allpools 1 -tstop 80 -logfile miner.log -wd 0 -mode 1 -platform 2
SET commandserver5=%minerpath% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.%ver% -epsw x -allpools 1 -tstop 80 -logfile miner.log -wd 0 -mode 1 -platform 2
SET ocprogram=0
SET profile=0
...
IF %queue% EQU 0 >> %bat% ECHO %minerpath% -epool eu1.ethermine.org:4444 -ewal 0x4a98909270621531dda26de63679c1c6fdcf32ea.%ver% -epsw x -allpools 1 -tstop 80 -logfile miner.log -wd 0 -mode 1 -platform 2
>> %bat% ECHO EXIT
timeout.exe /T 3 /nobreak >NUL
START "%bat%" "%bat%" && (
