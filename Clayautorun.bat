		...
		ECHO !LastInternetError!| findstr.exe /I /R %InternetErrorsList% && (
			...
			ping.exe google.com| find.exe /I "TTL=" >NUL && (
				...
				IF %EnableAdditionalServer% EQU 1 (
					...
					IF %ServerQueue% EQU 5 CALL :bat "ZecMiner64.exe -zpool eu1-zcash.flypool.org:3333 -zwal t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.dn175 -zpsw x -i 7 -tstop 95 -logfile miner.log" "1"
				) ELSE (
					CALL :bat "ZecMiner64.exe -zpool eu1-zcash.flypool.org:3333 -zwal t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.dn175 -zpsw x -i 7 -tstop 95 -logfile miner.log" "1"
				)
