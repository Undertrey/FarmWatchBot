...
:switch
COLOR 06
IF %EnableTelegramNotifications% EQU 1 "%CurlPath%" "https://api.telegram.org/bot438597926:AAGGY2wHtvLriYdlvgOuptjw8FJYj6rimac/sendMessage?chat_id=%ChatId%&parse_mode=markdown&text=*%RigName%:* Attempting to switch to the main pool server." 2>NUL 1>&2
...
:ctimer
COLOR 06
IF %EnableTelegramNotifications% EQU 1 "%CurlPath%" "https://api.telegram.org/bot438597926:AAGGY2wHtvLriYdlvgOuptjw8FJYj6rimac/sendMessage?chat_id=%ChatId%&parse_mode=markdown&text=*%RigName%:* Scheduled computer restart, please wait..." 2>NUL 1>&2
...
:mtimer
COLOR 06
IF %EnableTelegramNotifications% EQU 1 "%CurlPath%" "https://api.telegram.org/bot438597926:AAGGY2wHtvLriYdlvgOuptjw8FJYj6rimac/sendMessage?chat_id=%ChatId%&parse_mode=markdown&text=*%RigName%:* Scheduled miner restart, please wait..." 2>NUL 1>&2
...
:error
COLOR 0C
IF %EnableTelegramNotifications% EQU 1 "%CurlPath%" "https://api.telegram.org/bot438597926:AAGGY2wHtvLriYdlvgOuptjw8FJYj6rimac/sendMessage?chat_id=%ChatId%&parse_mode=markdown&text=*%RigName%:* Miner restarting..." 2>NUL 1>&2
ECHO ==================================================================
ECHO +----------------------------------------------------------------+
ECHO + Now %NowDate% %NowTime%                                           +
ECHO + Miner was started at %StartDate% %StartTime%                          +
...
IF %EnableAPAutorun% EQU 1 (
	...
	IF ERRORLEVEL ==1 (
		...
		IF %EnableTelegramNotifications% EQU 1 "%CurlPath%" "https://api.telegram.org/bot438597926:AAGGY2wHtvLriYdlvgOuptjw8FJYj6rimac/sendMessage?chat_id=%ChatId%&parse_mode=markdown&text=*%RigName%:* %APProcessName% was started." 2>NUL 1>&2
...
IF %EnableGPUOverclockMonitor% GEQ 1 (
	...
	IF ERRORLEVEL ==1 (
		...
		IF %EnableTelegramNotifications% EQU 1 "%CurlPath%" "https://api.telegram.org/bot438597926:AAGGY2wHtvLriYdlvgOuptjw8FJYj6rimac/sendMessage?chat_id=%ChatId%&parse_mode=markdown&text=*%RigName%:* %GPUOverclockProcess%.exe was started." 2>NUL 1>&2
...
IF ERRORLEVEL ==1 (
	...
	DEL /Q /F "%~dp0miner.log" >NUL || (
		...
		IF %EnableTelegramNotifications% EQU 1 "%CurlPath%" "https://api.telegram.org/bot438597926:AAGGY2wHtvLriYdlvgOuptjw8FJYj6rimac/sendMessage?chat_id=%ChatId%&parse_mode=markdown&text=*%RigName%:* Unable to delete miner.log." 2>NUL 1>&2
...
IF NOT EXIST "%~dp0miner.log" (
	...
	IF %EnableTelegramNotifications% EQU 1 "%CurlPath%" "https://api.telegram.org/bot438597926:AAGGY2wHtvLriYdlvgOuptjw8FJYj6rimac/sendMessage?chat_id=%ChatId%&parse_mode=markdown&text=*%RigName%:* Error. miner.log is missing.%%0ACheck permissions in "%~dp0". This script requires permission to create files." 2>NUL 1>&2
		...
		IF !SumResult! NEQ %OldHashrate% (
			...
			:passaveragecheck
				...
				IF %EnableGPUOverclockMonitor% NEQ 0 (
					tasklist /FI "IMAGENAME eq %GPUOverclockProcess%.exe" 2>NUL | find /I /N "%GPUOverclockProcess%.exe" >NUL
					IF ERRORLEVEL ==1 (
						IF %EnableTelegramNotifications% EQU 1 "%CurlPath%" "https://api.telegram.org/bot438597926:AAGGY2wHtvLriYdlvgOuptjw8FJYj6rimac/sendMessage?chat_id=%ChatId%&parse_mode=markdown&text=*%RigName%:* Process %GPUOverclockProcess%.exe crashed." 2>NUL 1>&2
				...
				IF %EnableTelegramNotifications% EQU 1 "%CurlPath%" "https://api.telegram.org/bot438597926:AAGGY2wHtvLriYdlvgOuptjw8FJYj6rimac/sendMessage?chat_id=%ChatId%&parse_mode=markdown&text=*%RigName%:* Abnormal hashrate. Average: *!SumResult!/%AverageTotalHashrate%* Last: *!LastHashrate!/%AverageTotalHashrate%*" >NUL
		...
		ECHO !LastInternetError! | findstr /R %InternetErrorsList% >NUL && (
			ping google.com | find /i "TTL=" >NUL && (
				ECHO %%N | findstr /R %InternetErrorsList% 2>NUL && (
					IF %EnableTelegramNotifications% EQU 1 "%CurlPath%" "https://api.telegram.org/bot438597926:AAGGY2wHtvLriYdlvgOuptjw8FJYj6rimac/sendMessage?chat_id=%ChatId%&parse_mode=markdown&text=*%RigName%:* %%N" 2>NUL 1>&2
					ECHO ==================================================================
					ECHO +----------------------------------------------------------------+
					ECHO + Now %NowDate% %NowTime%                                           +
					ECHO + Miner was started at %StartDate% %StartTime%                          +
				...
				ECHO %%N | findstr /R %InternetErrorsList% 2>NUL && (
					...
					:reconnected
					IF %EnableTelegramNotifications% EQU 1 "%CurlPath%" "https://api.telegram.org/bot438597926:AAGGY2wHtvLriYdlvgOuptjw8FJYj6rimac/sendMessage?chat_id=%ChatId%&parse_mode=markdown&text=*%RigName%:* Something was wrong with your Internet. Connection has been restored. Miner restarting..." 2>NUL 1>&2
...
IF %FirstRun% EQU 0 (
	...
	IF %EnableTelegramNotifications% EQU 0 (
