...
SET Server1BatCommand=%MinerProcess% -zpool eu1-zcash.flypool.org:3333 -zwal t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr187 -zpsw x -allpools 1 -tstop 80 -logfile %Logfile%
SET Server2BatCommand=%MinerProcess% -zpool eu1-zcash.flypool.org:3333 -zwal t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr187 -zpsw x -allpools 1 -tstop 80 -logfile %Logfile%
SET Server3BatCommand=%MinerProcess% -zpool eu1-zcash.flypool.org:3333 -zwal t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr187 -zpsw x -allpools 1 -tstop 80 -logfile %Logfile%
SET Server4BatCommand=%MinerProcess% -zpool eu1-zcash.flypool.org:3333 -zwal t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr187 -zpsw x -allpools 1 -tstop 80 -logfile %Logfile%
SET Server5BatCommand=%MinerProcess% -zpool eu1-zcash.flypool.org:3333 -zwal t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr187 -zpsw x -allpools 1 -tstop 80 -logfile %Logfile%
...
IF !ServerQueue! GEQ 6 >> %MinerBat% ECHO %MinerProcess% -zpool eu1-zcash.flypool.org:3333 -zwal t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr187 -zpsw x -allpools 1 -tstop 80 -logfile %Logfile%
>> %MinerBat% ECHO EXIT
timeout.exe /T 5 /nobreak >NUL
