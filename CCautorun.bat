...
SET Server1BatCommand=%MinerFilePath% -o stratum+tcp://yiimp.eu:4533 -a lyra2v2 -u Vy197bshDoH6dmGRx5ZwiGMfiPCf7ZG3yj -p c=VTC --no-color
SET Server2BatCommand=%MinerFilePath% -o stratum+tcp://yiimp.eu:4533 -a lyra2v2 -u Vy197bshDoH6dmGRx5ZwiGMfiPCf7ZG3yj -p c=VTC --no-color
SET Server3BatCommand=%MinerFilePath% -o stratum+tcp://yiimp.eu:4533 -a lyra2v2 -u Vy197bshDoH6dmGRx5ZwiGMfiPCf7ZG3yj -p c=VTC --no-color
SET Server4BatCommand=%MinerFilePath% -o stratum+tcp://yiimp.eu:4533 -a lyra2v2 -u Vy197bshDoH6dmGRx5ZwiGMfiPCf7ZG3yj -p c=VTC --no-color
SET Server5BatCommand=%MinerFilePath% -o stratum+tcp://yiimp.eu:4533 -a lyra2v2 -u Vy197bshDoH6dmGRx5ZwiGMfiPCf7ZG3yj -p c=VTC --no-color
...
IF !ServerQueue! GEQ 6 >> %MinerBat% ECHO ^>^> miner.log 2^>^&1 %MinerFilePath% -o stratum+tcp://yiimp.eu:4533 -a lyra2v2 -u Vy197bshDoH6dmGRx5ZwiGMfiPCf7ZG3yj -p c=VTC --no-color
>> %MinerBat% ECHO EXIT
timeout.exe /T 5 /nobreak >NUL
START "%MinerBat%" "%MinerBat%" && (
	...
	FOR /F "tokens=6,7 delims=/:= " %%a IN ('findstr.exe /R /C:".*%MinerProcess%.*" %MinerBat%') DO (
