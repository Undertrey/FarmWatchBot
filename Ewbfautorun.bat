...
SET Server1BatCommand=%MinerFilePath% --server eu1-zcash.flypool.org --port 3333 --user t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr188 --pass x --log 2 --fee 0 --templimit 80 --pec
SET Server2BatCommand=%MinerFilePath% --server eu1-zcash.flypool.org --port 3333 --user t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr188 --pass x --log 2 --fee 0 --templimit 80 --pec
SET Server3BatCommand=%MinerFilePath% --server eu1-zcash.flypool.org --port 3333 --user t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr188 --pass x --log 2 --fee 0 --templimit 80 --pec
SET Server4BatCommand=%MinerFilePath% --server eu1-zcash.flypool.org --port 3333 --user t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr188 --pass x --log 2 --fee 0 --templimit 80 --pec
SET Server5BatCommand=%MinerFilePath% --server eu1-zcash.flypool.org --port 3333 --user t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr188 --pass x --log 2 --fee 0 --templimit 80 --pec
...
IF !ServerQueue! GEQ 6 >> %MinerBat% ECHO %MinerFilePath% --server eu1-zcash.flypool.org --port 3333 --user t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr188 --pass x --log 2 --fee 0 --templimit 80 --pec
>> %MinerBat% ECHO EXIT
timeout.exe /T 5 /nobreak >NUL
...
IF NOT EXIST "%Logfile%" (
	...
	IF %ChatId% NEQ 0 CALL :telegram "false" "%Logfile% is missing. Ensure *--log 2* option is added to the miners command line. Check permissions of this folder. This script requires permission to create files."
	...
	findstr.exe /R /C:".*--server.*--log 2.*--templimit.*" %MinerBat% 2>NUL 1>&2 || (
		ECHO Ensure --server --log 2 --templimit options added to the miners command line in this order.
		IF %ChatId% NEQ 0 CALL :telegram "false" "Ensure *--server* *--log 2* *--templimit* options added to the miners command line in this order."
		>> %~n0.log ECHO [%Date%][%Time:~-11,8%] Ensure --server --log 2 --templimit options added to the miners command line in this order.
	)
