...
IF !ServerQueue! GEQ 6 >> %MinerBat% ECHO %MinerProcess% --server eu1-zcash.flypool.org --port 3333 --user t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr186 --pass x --logfile --time --temp-target 80
>> %MinerBat% ECHO EXIT
timeout.exe /T 5 /nobreak >NUL
